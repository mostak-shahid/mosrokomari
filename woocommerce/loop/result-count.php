...
<p class="woocommerce-result-view">
	<a class="grid-view" data-id="grid-view" href="javascript:void(0)"><i class="fa fa-th"></i></a>
	<a class="list-view" data-id="list-view" href="javascript:void(0)"><i class="fa fa-th-list"></i></a>
</p>
