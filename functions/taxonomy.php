<?php
// hook into the init action and call mosrokomari_taxonomies when it fires
//add_action( 'init', 'mosrokomari_portfolio_taxonomies', 0 );

// create two taxonomies, categories and tags for the post type "book"
function mosrokomari_portfolio_taxonomies() {
