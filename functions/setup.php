<?php
//Add theme setup
if ( ! function_exists( 'mosrokomari_setup' ) ) :
	function mosrokomari_setup() {
		...
		register_nav_menus( array(
			'mainmenu' => __('Main Menu', 'mosrokomari'),
			'mobilemenu' => __('Mobile Menu', 'mosrokomari'),
		));
...
add_action( 'after_setup_theme', 'mosrokomari_setup' );