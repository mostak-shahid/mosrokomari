...
function mosrokomari_customize_register( $wp_customize ){
    $wp_customize->add_section('mosremovals_standard_colors', array(
        'title' =>__('Standard Colors', 'mosremovals'),
        'priority' =>30,
    ));
    $wp_customize->add_setting('mosremovals_link_color', array(
        'default' => '#006ec3',
        'transport' => 'refresh',
    ));
    $wp_customize->add_control( new WP_Customize_Color_control( $wp_customize, 'mosremovals_link_color_control', array( 
        'label' => __('Link Color', 'mosremovals'),
        'section' => 'mosremovals_standard_colors',
        'settings' => 'mosremovals_link_color',
    ) ) );
}
add_action('customize_register', 'mosrokomari_customize_register'); 
//Output Customize CSS
function mosrokomari_customize_css(){?>
    <style type="text/css">
        a:link,
        a:visited {
            color:<?php echo get_theme_mod('mosremovals_link_color'); ?>
        }
    </style>
<?php }
add_action('wp_head', 'mosrokomari_customize_css');
