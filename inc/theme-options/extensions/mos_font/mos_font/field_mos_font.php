    ...
    class ReduxFramework_mos_font {
        ...
        public function render() {
             ...
             $defaults = array(
                ...
                'content_title' => __ ( 'Slide', 'mosrokomari' )
            );
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                foreach ( $slides as $slide ) {
                    ...
                    if ( $this->field[ 'show' ][ 'url-eot' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-url-eot' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][url-eot]" value="' . esc_attr($slide['url-eot']) . '" placeholder="'.esc_attr__('Eot Link', 'mosrokomari').'" class="full-text" /></li>';
                    }
                    
                    if ( $this->field[ 'show' ][ 'url-woff' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-url-woff_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][url-woff]" value="' . esc_attr($slide['url-woff']) . '" placeholder="'.esc_attr__('Woff Link', 'mosrokomari').'" class="full-text" /></li>';
                    }
                    
                    if ( $this->field[ 'show' ][ 'url-woff2' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-url-woff2_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][url-woff2]" value="' . esc_attr($slide['url-woff2']) . '" placeholder="'.esc_attr__('Woff2 Link', 'mosrokomari').'" class="full-text" /></li>';
                    }
                    
                    if ( $this->field[ 'show' ][ 'url-ttf' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-url-ttf_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][url-ttf]" value="' . esc_attr($slide['url-ttf']) . '" placeholder="'.esc_attr__('Ttf Link', 'mosrokomari').'" class="full-text" /></li>';
                    }
                    
                    if ( $this->field[ 'show' ][ 'url-svg' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-url-svg_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][url-svg]" value="' . esc_attr($slide['url-svg']) . '" placeholder="'.esc_attr__('Ttf Link', 'mosrokomari').'" class="full-text" /></li>';
                    }
                    
                    if ( $this->field[ 'show' ][ 'weight' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-weight_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][weight]" value="' . esc_attr($slide['weight']) . '" placeholder="'.esc_attr__('Weight', 'mosrokomari').'" class="full-text" /></li>';
                    }
                    
                    if ( $this->field[ 'show' ][ 'style' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-style' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][style]" value="' . esc_attr($slide['style']) . '" placeholder="'.esc_attr__('Style', 'mosrokomari').'" class="full-text" /></li>';
                    }
            ...
            if ($x == 0) {
                ...
                if ( $this->field[ 'show' ][ 'url-eot' ] ) {
                    $placeholder = (isset($this->field['placeholder']['url-eot'])) ? esc_attr($this->field['placeholder']['url-eot']) : __( 'Eot Link', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'url-woff' ] ) {
                    $placeholder = (isset($this->field['placeholder']['url-woff'])) ? esc_attr($this->field['placeholder']['url-woff']) : __( 'Woff Link', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'url-woff2' ] ) {
                    $placeholder = (isset($this->field['placeholder']['url-woff2'])) ? esc_attr($this->field['placeholder']['url-woff2']) : __( 'Woff2 Link', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'url-ttf' ] ) {
                    $placeholder = (isset($this->field['placeholder']['url-ttf'])) ? esc_attr($this->field['placeholder']['url-ttf']) : __( 'Ttf Link', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'url-svg' ] ) {
                    $placeholder = (isset($this->field['placeholder']['url-svg'])) ? esc_attr($this->field['placeholder']['url-svg']) : __( 'Svg Link', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'weight' ] ) {
                    $placeholder = (isset($this->field['placeholder']['weight'])) ? esc_attr($this->field['placeholder']['weight']) : __( 'Weight', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'style' ] ) {
                    $placeholder = (isset($this->field['placeholder']['style'])) ? esc_attr($this->field['placeholder']['style']) : __( 'Style', 'mosrokomari' );
