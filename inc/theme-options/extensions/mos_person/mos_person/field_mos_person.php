    ...
    class ReduxFramework_mos_person {
        ...
        public function render() {
             ...
             $defaults = array(
                ...
                'content_title' => __ ( 'Person', 'mosrokomari' )
            );

             $this->field = wp_parse_args ( $this->field, $defaults );
			/* translators: %s: slide */
           	echo '<div class="redux-slides-accordion" data-new-content-title="' . esc_attr ( sprintf ( __ ( 'New %s', 'mosrokomari' ), $this->field[ 'content_title' ] ) ) . '">';
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                foreach ( $slides as $slide ) {
                   ...
                   if ( empty ( $slide[ 'thumb' ] ) && !empty ( $slide[ 'attachment_id' ] ) ) {
                    ...
                    echo '<span class="button media_upload_button" id="add_' . esc_attr( $x ) . '">' . esc_html__( 'Upload', 'mosrokomari' ) . '</span>';
                    ...
                    echo '<span class="button remove-image' . esc_attr( $hide ) . '" id="reset_' . esc_attr( $x ) . '" rel="' . esc_attr( $slide[ 'attachment_id' ] ) . '">' . esc_html__( 'Remove', 'mosrokomari' ) . '</span>';

                    echo '</div>' . "\n";

                    echo '<ul id="' . esc_attr( $this->field[ 'id' ] ) . '-ul" class="redux-slides-list">';

                    echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-title_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][title]" value="' . esc_attr($slide['title']) . '" placeholder="'.esc_html__('Title', 'mosrokomari').'" class="full-text slide-title" /></li>';
                    if ( $this->field[ 'show' ][ 'description' ] ) {
                        echo '<li><textarea name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][description]" id="' . esc_attr( $this->field['id'] ) . '-description_' . esc_attr( $x ) . '" placeholder="'.esc_attr__('Description', 'mosrokomari').'" class="large-text" rows="6">' . esc_attr($slide['description']) . '</textarea></li>';
                    }
                    if ( $this->field[ 'show' ][ 'address' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-address_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][address]" value="' . esc_attr($slide['address']) . '" placeholder="'.esc_attr__('Address', 'mosrokomari').'" class="full-text slide-address" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'organization' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-organization_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][organization]" value="' . esc_attr($slide['organization']) . '" placeholder="'.esc_attr__('Organization', 'mosrokomari').'" class="full-text slide-address" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'phone' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-phone_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][phone]" value="' . esc_attr($slide['phone']) . '" placeholder="'.esc_attr__('Phone', 'mosrokomari').'" class="full-text slide-phone" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'email' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-email_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][email]" value="' . esc_attr($slide['email']) . '" class="full-text slide-email" placeholder="'.esc_html__('Email', 'mosrokomari').'" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'facebook' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-facebook_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][facebook]" value="' . esc_attr($slide['facebook']) . '" class="full-text slide-facebook" placeholder="'.esc_html__('Facebook', 'mosrokomari').'" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'twitter' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-twitter_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][twitter]" value="' . esc_attr($slide['twitter']) . '" class="full-text slide-twitter" placeholder="'.esc_html__('Twitter', 'mosrokomari').'" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'linkedin' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-linkedin_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][linkedin]" value="' . esc_attr($slide['linkedin']) . '" class="full-text slide-linkedin" placeholder="'.esc_html__('LinkedIn', 'mosrokomari').'" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'google-plus' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-google-plus_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][google-plus]" value="' . esc_attr($slide['google-plus']) . '" class="full-text slide-google-plus" placeholder="'.esc_html__('Google Plus', 'mosrokomari').'" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'instagram' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-instagram_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][instagram]" value="' . esc_attr($slide['instagram']) . '" class="full-text slide-instagram" placeholder="'.esc_html__('Instagram', 'mosrokomari').'" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'youtube' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-youtube' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][youtube]" value="' . esc_attr($slide['youtube']) . '" class="full-text slide-youtube" placeholder="'.esc_html__('Youtube', 'mosrokomari').'" /></li>';
                    }
                    ...
                    echo '<li><a href="javascript:void(0);" class="button deletion redux-slides-remove">' . esc_html__('Delete Person', 'mosrokomari') . '</a></li>';
            ...
            if ($x == 0) {
                ...
                echo '<span class="button remove-image' . esc_attr( $hide ) . '" id="reset_' . esc_attr( $x ) . '" rel="' . esc_attr( $this->parent->args[ 'opt_name' ] ) . '[' . esc_attr( $this->field[ 'id' ] ) . '][attachment_id]">' . esc_html__( 'Remove', 'mosrokomari' ) . '</span>';

                echo '</div>' . "\n";

                echo '<ul id="' . esc_attr( $this->field['id'] ) . '-ul" class="redux-slides-list">';
                $placeholder = (isset($this->field['placeholder']['title'])) ? esc_attr($this->field['placeholder']['title']) : __( 'Title', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'description' ] ) {
                    $placeholder = (isset($this->field['placeholder']['description'])) ? esc_attr($this->field['placeholder']['description']) : __( 'Description', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'address' ] ) {
                    $placeholder = (isset($this->field['placeholder']['address'])) ? esc_attr($this->field['placeholder']['address']) : __( 'Address', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'organization' ] ) {
                    $placeholder = (isset($this->field['placeholder']['organization'])) ? esc_attr($this->field['placeholder']['organization']) : __( 'Organization', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'phone' ] ) {
                    $placeholder = (isset($this->field['placeholder']['phone'])) ? esc_attr($this->field['placeholder']['phone']) : __( 'Phone', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'email' ] ) {             
                    $placeholder = (isset($this->field['placeholder']['email'])) ? esc_attr($this->field['placeholder']['email']) : __( 'Email', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'facebook' ] ) {             
                    $placeholder = (isset($this->field['placeholder']['facebook'])) ? esc_attr($this->field['placeholder']['facebook']) : __( 'Facebook', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'twitter' ] ) {             
                    $placeholder = (isset($this->field['placeholder']['twitter'])) ? esc_attr($this->field['placeholder']['twitter']) : __( 'Twitter', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'linkedin' ] ) {             
                    $placeholder = (isset($this->field['placeholder']['linkedin'])) ? esc_attr($this->field['placeholder']['linkedin']) : __( 'LinkedIn', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'google-plus' ] ) {             
                    $placeholder = (isset($this->field['placeholder']['google-plus'])) ? esc_attr($this->field['placeholder']['google-plus']) : __( 'Google Plus', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'instagram' ] ) {             
                    $placeholder = (isset($this->field['placeholder']['instagram'])) ? esc_attr($this->field['placeholder']['instagram']) : __( 'Instagram', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'youtube' ] ) {             
                    $placeholder = (isset($this->field['placeholder']['youtube'])) ? esc_attr($this->field['placeholder']['youtube']) : __( 'Youtube', 'mosrokomari' );
            ...
            /* translators: %s: slide */
            echo '</div><a href="javascript:void(0);" class="button redux-slides-add2 mos_redux-slides-add button-primary" rel-id="' . esc_attr( $this->field[ 'id' ] ) . '-ul" rel-name="' . esc_attr( $this->field[ 'name' ] ) . '[title][]">' . sprintf ( esc_html__( 'Add %s', 'mosrokomari' ), esc_attr( $this->field[ 'content_title' ] ) ) . '</a><br/>';
        }
