    ...
    class ReduxFramework_mos_address {
        ...
        public function render() {
             ...
             $defaults = array(
                ...
                'content_title' => __ ( 'Address', 'mosrokomari' )
            );
            ...
            if ( isset ( $this->value ) && is_array ( $this->value ) && !empty ( $this->value ) ) {
                ...
                foreach ( $slides as $slide ) {
                   ...
                   if ( empty ( $slide[ 'thumb' ] ) && !empty ( $slide[ 'attachment_id' ] ) ) {
                    ...
                    echo '<span class="button media_upload_button" id="add_' . esc_attr( $x ) . '">' . esc_html__( 'Upload Map Image', 'mosrokomari' ) . '</span>';
                    ...
                    echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-title_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][title]" value="' . esc_attr($slide['title']) . '" placeholder="'.esc_html__('Map Title', 'mosrokomari').'" class="full-text slide-title" /></li>';
                    if ( $this->field[ 'show' ][ 'description' ] ) {
                        echo '<li><textarea name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][description]" id="' . esc_attr( $this->field['id'] ) . '-description_' . esc_attr( $x ) . '" placeholder="'.esc_attr__('Address', 'mosrokomari').'" class="large-text" rows="6">' . esc_attr($slide['description']) . '</textarea></li>';
                    }
                    if ( $this->field[ 'show' ][ 'map_link' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-map_link_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][map_link]" value="' . esc_attr($slide['map_link']) . '" placeholder="'.esc_attr__('Map link', 'mosrokomari').'" class="full-text" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'review_link' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-review_link_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][review_link]" value="' . esc_attr($slide['review_link']) . '" class="full-text" placeholder="'.esc_html__('Review Link', 'mosrokomari').'" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'review_link_img' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-review_link_img_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][review_link_img]" value="' . esc_attr($slide['review_link_img']) . '" class="full-text" placeholder="'.esc_html__('Review Link Image', 'mosrokomari').'" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'review_link_img_h' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-review_link_img_h_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][review_link_img_h]" value="' . esc_attr($slide['review_link_img_h']) . '" class="full-text" placeholder="'.esc_html__('Review Link Hover Image', 'mosrokomari').'" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'target' ] ) {
                        ...
                        echo ' '.esc_html__('Open Link in New Tab/Window', 'mosrokomari'). '</label></li>';
                    }
                    ...
                    echo '<li><a href="javascript:void(0);" class="button deletion redux-slides-remove">' . esc_html__('Delete Slide', 'mosrokomari') . '</a></li>';
            ...
            if ($x == 0) {
                ...
                echo '<ul id="' . esc_attr( $this->field['id'] ) . '-ul" class="redux-slides-list">';
                $placeholder = (isset($this->field['placeholder']['title'])) ? esc_attr($this->field['placeholder']['title']) : __( 'Map Title', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'description' ] ) {
                    $placeholder = (isset($this->field['placeholder']['description'])) ? esc_attr($this->field['placeholder']['description']) : __( 'Address', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'map_link' ] ) {
                    $placeholder = (isset($this->field['placeholder']['map_link'])) ? esc_attr($this->field['placeholder']['map_link']) : __( 'Map link', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'review_link' ] ) {             
                    $placeholder = (isset($this->field['placeholder']['review_link'])) ? esc_attr($this->field['placeholder']['review_link']) : __( 'Review Link', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'review_link_img' ] ) {             
                    $placeholder = (isset($this->field['placeholder']['review_link_img'])) ? esc_attr($this->field['placeholder']['review_link_img']) : __( 'Review Link Image', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'review_link_img_h' ] ) {             
                    $placeholder = (isset($this->field['placeholder']['review_link_img_h'])) ? esc_attr($this->field['placeholder']['review_link_img_h']) : __( 'Review Link Hover Image', 'mosrokomari' );
