    ...
    class ReduxFramework_mos_social {
        ...
        public function render() {
             ...
             $defaults = array(
                ...
                'content_title' => __ ( 'Social Media', 'mosrokomari' )
            );
                ...
                foreach ( $slides as $slide ) {
                   ...
                   //  echo '</div>' . "\n";               
                    ...
                    if ( $this->field[ 'show' ][ 'basic_icon' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-basic_icon_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][basic_icon]" value="' . esc_attr($slide['basic_icon']) . '" placeholder="'.esc_attr__('Basic Icon/Image', 'mosrokomari').'" class="full-text iconlist" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'hover_icon' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-hover_icon_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][hover_icon]" value="' . esc_attr($slide['hover_icon']) . '" placeholder="'.esc_attr__('Hover Icon/Image', 'mosrokomari').'" class="full-text" /></li>';
                    }
                    if ( $this->field[ 'show' ][ 'link_url' ] ) {
                        echo '<li><input type="text" id="' . esc_attr( $this->field['id'] ) . '-link_url_' . esc_attr( $x ) . '" name="' . esc_attr( $this->field['name'] ) . '[' . esc_attr( $x ) . '][link_url]" value="' . esc_attr($slide['link_url']) . '" class="full-text upload" placeholder="'.esc_html__('URL', 'mosrokomari').'" /></li>';
                    }
            ...
            if ($x == 0) {
                ...
                if ( $this->field[ 'show' ][ 'basic_icon' ] ) {
                    $placeholder = (isset($this->field['placeholder']['basic_icon'])) ? esc_attr($this->field['placeholder']['basic_icon']) : __( 'Basic Icon/Image', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'hover_icon' ] ) {
                    $placeholder = (isset($this->field['placeholder']['hover_icon'])) ? esc_attr($this->field['placeholder']['hover_icon']) : __( 'Hover Icon/Image', 'mosrokomari' );
                ...
                if ( $this->field[ 'show' ][ 'link_url' ] ) {             
                    $placeholder = (isset($this->field['placeholder']['link_url'])) ? esc_attr($this->field['placeholder']['link_url']) : __( 'URL', 'mosrokomari' );
