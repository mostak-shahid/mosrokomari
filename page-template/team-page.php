...
do_action( 'action_avobe_team_page', $page_details ); 
?>
...
<section id="team-page" class="page-content">
	<div class="content-wrap">
		...
		*/
		...
		<?php if($page_layout != 'ns') : ?>
			...
			<?php endif; ?>
				...
				*/
				do_action( 'action_team_archive_page', $page_details ); 
				?>
				<?php if($page_layout != 'ns') : ?>
				</div>
		...
		* @hooked end_div 10 
		*/
		do_action( 'action_after_team_page', $page_details ); 
		?>
	</div>
</section>
